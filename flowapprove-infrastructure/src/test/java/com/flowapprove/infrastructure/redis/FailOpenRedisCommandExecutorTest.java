...
class FailOpenRedisCommandExecutorTest {
    ...
    void returnsFallbackWhenRedisThrows() {
        FailOpenRedisCommandExecutor executor = new FailOpenRedisCommandExecutor(true, new RedisAvailabilityGuard(Duration.ofSeconds(30)));
    ...
    void skipsExecutionWhenRedisFeatureDisabled() {
        FailOpenRedisCommandExecutor executor = new FailOpenRedisCommandExecutor(false, new RedisAvailabilityGuard(Duration.ofSeconds(30)));
